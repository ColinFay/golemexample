...
golem::fill_desc(
  pkg_name = "golemexample", # The Name of the package containing the App 
  pkg_title = "Golem Example", # The Title of the package containing the App 
  pkg_description = "A Package to show the basics of a golem.", # The Description of the package containing the App 
  author_first_name = "Colin", # Your First Name
  author_last_name = "Fay",  # Your Last Name
  author_email = "contact@colinfay.me",      # Your Email
  repo_url = "https://github.com/colinfay/golemexample" # The (optional) URL of the GitHub Repo
)     
...
usethis::use_mit_license( name = "Colin Fay" )  # You can set another licence here
